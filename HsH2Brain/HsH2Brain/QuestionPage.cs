...
namespace HsH2Brain
{
    public class QuestionPage : ContentPage
    {
        ...
        private QuestionSetModel CurrentQuestionSet { get; }

        // this will change for sure
        private Label TextLabel { get; }
        private Label WrongLabel { get; }
        private Label CorrectLabel { get; }
        private Label BucketLabel { get; }
        ...
        {
            WrongLabel.Text = $"Falsch: {CurrentQuestion.WrongAnswers}x";
            CorrectLabel.Text = $"Richtig: {CurrentQuestion.CorrectAnswers}x";
            BucketLabel.Text = $"Bucket: {CurrentQuestion.Bucket}";
        }
    }
}